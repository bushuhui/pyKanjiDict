...
#
#	$Id: FileEnt.tcl,v 1.3.2.3 2002/01/24 10:08:58 idiscovery Exp $
#
# FileEnt.tcl --
#
...
proc tixFileEntry:OpenFile {w} {
	 ...
	 set retval [eval tk_chooseDirectory $args]

	 if {$retval != ""} {tixFileEntry:SetValue $w [file native $retval]}
